  ...
  <Row className="mb-4">
    <Col md={8}>
      ...
      <p className="mt-2">
        ...
        <a href="https://osf.io/mgjpp">NSF DART Data Management Plan Rubric</a> and provide feedback for each criteria
        in the NSF guidelines.
      </p>
      ...
      <Accordion>
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            No. This application doesn’t use or save your plan to train the model. The AI-generated response is based on
            the National Science Foundation’s DART Data Management Plan Rubric to gauge your plan’s effectiveness.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            Although this DMSP AI Feedback Tool is currently configured to review plans using the NSF guidelines, there
            are plans to add support for additional funding agencies in the near future. As those agencies are added to
            this tool, this page will be updated to reflect the available agencies’ guidelines. In the meantime, if you
            use this tool for an unsupported agency, your plan will be evaluated against the NSF criteria, and the
            evaluation may not be accurate for your funding agency’s criteria.
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="3">
          ...
          <Accordion.Body>
            There are two ways to get your plan into the ASU DMSP AI Feedback Tool. From the landing page, you can paste
            in the entire text from the plan OR if the DMSP in the DMPTool has been made public, the assigned DMP ID can
            be entered and the AI Feedback Tool will retrieve your DMP from the DMPTool.
          </Accordion.Body>
        </Accordion.Item>

        <Accordion.Item eventKey="4">
          <Accordion.Header>Who can see my plan?</Accordion.Header>
          <Accordion.Body>Staff in the Research Technology Office and ASU Library Researcher Support.</Accordion.Body>
        </Accordion.Item>
