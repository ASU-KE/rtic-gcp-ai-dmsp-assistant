  ...
  return (
    <Row className="mb-4">
      <Col md={8}>
        ...
        <p className="mt-2">
          The ASU DMSP AI Tool was developed in partnership with the Association of Research Libraries and the
        ...
        <p className="mt-2">
          This beta test is a standalone tool for which ASU researchers may submit a draft or final copy of their DMSP
