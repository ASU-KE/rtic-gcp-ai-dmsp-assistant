...
export const HomePage = () => {
  return (
    <Row className="mb-4">
      <Col md={8}>
        <h2 className="mt-2">Welcome to the Data Management and Sharing Plan (DMSP) AI Tool Beta!</h2>

        <p className="mt-2">
          The DMSP AI Tool was developed in partnership with the Association of Research Libraries and the
          California Digital Library, which is responsible for the development of the{' '}
        ...
        <p className="mt-2">
          This beta test is a standalone tool for which researchers may submit a draft or final copy of their DMSP
          and receive an analysis report of the plan's strengths and weaknesses. This AI tool will review the plan using
          the <a href="https://osf.io/mgjpp">NSF DART Data Management Plan Rubric</a> and provide feedback for each
          criteria in the NSF guidelines.
        </p>
        ...
        <p className="mt-2">
          If you have been invited to test this beta tool, please understand this is a Work-in-Progress, and this AI
          tool may not be complete or accurate. Please document any issues or concerns you uncover while using this
          tool, and please provide feedback on how we might improve this tool.
        </p>
        ...
        <Accordion>
          ...
          <Accordion.Item eventKey="2">
            <Accordion.Header>Which model is used in the DMSP AI Tool?</Accordion.Header>
            <Accordion.Body>
              The DMSP AI Feedback Tool uses the Gemini 2 Flash hosted in{' '}
          ...
          <Accordion.Item eventKey="3">
            ...
            <Accordion.Body>
              There are two ways to get your plan into the DMSP AI Feedback Tool. From the landing page, you can
          ...
          <Accordion.Item eventKey="4">
            ...
            <Accordion.Body>Staff in the Research Technology Office and Library Researcher Support.</Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="5">
            ...
            <Accordion.Body>
              ...
              feedback, the AI Feedback Tool will retain your DMSP for administrative support purposes only.
            </Accordion.Body>
          </Accordion.Item>
